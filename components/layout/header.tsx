...
function getPageInfo(pathname: string): { title: string; subtitle: string } | null {
  if (pathname.startsWith('/dashboard')) return { title: 'Dashboard', subtitle: 'At a glance' };
  if (pathname.startsWith('/candidates')) return { title: 'Candidates', subtitle: 'Candidate pipeline' };
  if (pathname.startsWith('/competencies')) return { title: 'Competencies', subtitle: 'Review specialised competency assessments' };
  if (pathname.startsWith('/personnel')) return { title: 'Personnel', subtitle: 'Manage team and permissions' };
  if (pathname.startsWith('/log')) return { title: 'Audit Log', subtitle: 'System activity' };
  if (pathname.startsWith('/settings')) return { title: 'Settings', subtitle: 'Profile and preferences' };
  return null;
}
