    ...
    const validPayload: TallyWebhookPayload = {
      ...
      data: {
        ...
        fields: [
          ...
          { key: APPLICATION_FIELD_KEYS.academicBackground, label: 'Academic Background', type: 'TEXTAREA', value: 'CS degree from MIT' },
          { key: APPLICATION_FIELD_KEYS.previousExperience, label: 'Previous Experience', type: 'TEXTAREA', value: '5 years at Google' },
          { key: APPLICATION_FIELD_KEYS.videoLink, label: 'Video Introduction', type: 'INPUT_LINK', value: 'https://youtube.com/watch?v=123' },
          {
    ...
    const validPayload: TallyWebhookPayload = {
      ...
      data: {
        ...
        fields: [
          ...
          { key: AGREEMENT_FIELD_KEYS.preferredFirstName, label: 'First Preferred Name', type: 'INPUT_TEXT', value: 'Johnny' },
          { key: AGREEMENT_FIELD_KEYS.preferredLastName, label: 'Last Preferred Name', type: 'INPUT_TEXT', value: 'D' },
          {
          ...
          { key: AGREEMENT_FIELD_KEYS.biography, label: 'Would you like to provide a short biography?', type: 'TEXTAREA', value: 'A developer.' },
          ...
          { key: AGREEMENT_FIELD_KEYS.entityRepresented, label: 'Entity Represented', type: 'INPUT_TEXT', value: 'Self' },
      ...
      const minimalPayload: TallyWebhookPayload = {
        ...
        data: {
          ...
          fields: [
            ...
            { key: AGREEMENT_FIELD_KEYS.legalFirstName, label: 'First Legal Name', type: 'INPUT_TEXT', value: 'Jane' },
            { key: AGREEMENT_FIELD_KEYS.legalLastName, label: 'Last Legal Name', type: 'INPUT_TEXT', value: 'Smith' },
          ],
        },
      };
